...
```bash
openclaw plugins install https://github.com/xiotbox/openclaw-channel-xiotbox.git#5.0.2
```

Or use the maintained helper script:

```bash
bash scripts/update_openclaw_xiotbox.sh 5.0.2
# or
bash scripts/update_openclaw_xiotbox.sh https://github.com/xiotbox/openclaw-channel-xiotbox.git#5.0.2
```
