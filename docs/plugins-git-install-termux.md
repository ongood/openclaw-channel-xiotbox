...
```bash
openclaw plugins install https://github.com/ongood/openclaw-channel-xiotbox.git#4.0.1
```
...
# or
bash scripts/update_openclaw_xiotbox.sh https://github.com/ongood/openclaw-channel-xiotbox.git#4.0.1
```
