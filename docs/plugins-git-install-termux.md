...
```bash
openclaw plugins install https://github.com/xiotbox/openclaw-channel-xiotbox.git#4.0.9
```

Or use the maintained helper script:

```bash
bash scripts/update_openclaw_xiotbox.sh 4.0.9
# or
bash scripts/update_openclaw_xiotbox.sh https://github.com/xiotbox/openclaw-channel-xiotbox.git#4.0.9
```
