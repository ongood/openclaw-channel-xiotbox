...
```bash
openclaw plugins install https://github.com/ongood/openclaw-channel-xiotbox.git#3.1.0
```

Or use the maintained helper script:

```bash
bash scripts/update_openclaw_xiotbox.sh 3.1.0
# or
bash scripts/update_openclaw_xiotbox.sh https://github.com/ongood/openclaw-channel-xiotbox.git#3.1.0
```
