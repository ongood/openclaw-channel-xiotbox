...
> Type: COMPLETED SPIKE · Decision recorded for 3.1 · Not current 4.0.12 architecture
>
> Goal: record the completed 3.1 investigation. Current behavior must be verified against version 4.0.12 code and tests.
